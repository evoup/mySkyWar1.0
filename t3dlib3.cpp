...
extern HWND globalhwnd;     // access to main window handle in main module
...
if (first_time)
	...
	if (FAILED(lpds->SetCooperativeLevel((HWND)globalhwnd,DSSCL_NORMAL)))
		return(0);
...
if (FAILED(dm_perf->Init(NULL, lpds, globalhwnd)))
   {
